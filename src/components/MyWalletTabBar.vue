<template>
  <ion-tab-bar slot="bottom">
    <ion-tab-button tab="home" href="/my-wallet/main">
      <ion-icon :icon="walletOutline" />
      <ion-label>Main</ion-label>
    </ion-tab-button>

    <ion-tab-button tab="transactions" href="/my-wallet/transactions">
      <ion-icon :icon="cash" />
      <ion-label>Transactions</ion-label>
    </ion-tab-button>

    <ion-tab-button tab="assets" href="/my-wallet/assets">
      <ion-icon :icon="diamond" />
      <ion-label>Assets</ion-label>
    </ion-tab-button>

    <ion-tab-button tab="settings" href="/my-wallet/settings">
